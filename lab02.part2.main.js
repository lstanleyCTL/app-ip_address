 ...
 * @return {string} (firstIpAddress) - An object that has the IPv4 and IPv6 version of the first ip found.
 */
...
function main() {
  ...
  for (let i = 0; i < sampleCidrsLen; i++) {
    ...
    getFirstIpAddress(sampleCidrs[i], (data, error) => {
      ...
      console.log(`  Response returned from GET request: ${data.ipv4} and ${data.ipv6}`);
    });
  }
